    ...
    <footer className="bg-secondary-900 text-gray-300">
      <div className="container-custom py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Company info */}
          <div>
            <h3 className="text-white text-xl font-bold mb-4">SanixHub</h3>
            ...
            <div className="flex gap-4">
              ...
              <a href={`https://wa.me/${whatsappNumber}`} className="hover:text-white transition" target="_blank" rel="noopener noreferrer">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/products" className="hover:text-white transition">{t('footer.products')}</Link></li>
              <li><Link href="/categories" className="hover:text-white transition">{t('footer.categories')}</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/shipping" className="hover:text-white transition">{t('footer.shipping')}</Link></li>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-sm text-center">
          <p>&copy; {currentYear} SanixHub. {t('footer.rights')}</p>
        </div>
      </div>
    </footer>
  );
